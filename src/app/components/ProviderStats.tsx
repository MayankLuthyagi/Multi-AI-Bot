        ...
        <div className="space-y-6">
            ...
            <div className="text-center space-x-4">
                <button
                    ...
                    className="px-8 py-3 bg-gradient-to-r from-gray-700 to-gray-800 text-white font-medium rounded-lg hover:from-gray-600 hover:to-gray-700 transition-all duration-300 inline-flex items-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg border border-gray-600 hover:shadow-xl"
                >
                    {recalculating ? (
                        <>
